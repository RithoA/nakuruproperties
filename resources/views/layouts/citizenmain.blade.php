...
<body class="profile-page">
	...
	<div class="wrapper">
	    <div class="sidebar" data-active-color="{{ session()->get('type')}}"  data-background-color="black" data-image="{{ Storage::url($profile->coverimage) }}">
			...
			<div class="logo">
				<a href="{{route('pr.adminprofile')}}" class="simple-text">
					Nakuru Properties
				</a>
			</div>
	    	...
	    	<div class="photo">
 			...
 			<div class="info">
                        ...
                        <ul class="nav">
                            @if(auth::id() == $user->id)
                            <li><a href="{{route('pr.adminprofile')}}">Profile</a></li>
                            <li><a href="{{route('pr.editadminprofile')}}">Edit Profile</a></li>
                            <li>
                                        <a href="{{ route('logout') }}"
				...
				<ul class="nav">
	                <li>
	                    <a href="{{route('pr.adminhome')}}">
	                        <i class="material-icons">home</i>
	                        <p>Home</p>
	                    </a>
	                </li>
	                <li class="dropdown active">
	                 <a style="background-color: #9c27b0;" href="#dropdownposts" data-toggle="collapse" class="collapsed active"><i class="material-icons">chrome_reader_mode</i><p>Posts<b class="caret"></b></p></a>
	                 <div class="collapse" id="dropdownposts">
                        <ul class="nav">
                            <li><a href="{{route('pr.newpost')}}"><i class="material-icons">note_add</i>
	                        <p>Create Posts</p>
	                    </a></li>
                            <li><a href="{{route('pr.listposts')}}"><i class="material-icons">chrome_reader_mode</i>
	                        <p>Posts</p>
	                    </a></li>
                        </ul>
                        </div>
	                 ...
	                 <li class="dropdown">
	                 <a href="#dropdownusers" data-toggle="collapse" class="collapsed active"><i class="material-icons">face</i><p>Users<b class="caret"></b></p></a>
	                 <div class="collapse" id="dropdownusers">
                        <ul class="nav">
                            <li><a href="{{route('pr.newuser')}}">
	                        <i class="material-icons text-gray">face</i>
	                        <p>Create Users</p>
	                    </a></li>
                            <li><a href="{{route('pr.listusers')}}">
	                 ...
	                 <li class="dropdown">
	                 <a  href="#dropdownclass" data-toggle="collapse" class="collapsed active"><i class="material-icons">view_week</i><p>Classifications<b class="caret"></b></p></a>
	                 <div class="collapse" id="dropdownclass">
                        <ul class="nav">
                        <li><a href="{{route('pr.newcategory')}}">
                            <i class="material-icons text-gray">view_week</i>
                            <p>Create Class</p>
                            </a></li>
                            <li><a href="{{route('pr.listcategories')}}">
                            <i class="material-icons text-gray">view_compact</i>
                            <p>Categories</p>
                            </a></li>
                            <li><a href="{{route('pr.listtags')}}">
                            <i class="material-icons text-gray">view_list</i>
                            <p>Tags</p>
                        </a></li>
                        <li><a href="{{route('pr.listowners')}}">
                            <i class="material-icons text-gray">attach_money</i>
                            <p>Property Owners</p>
                        </a></li>
                        <li><a href="{{route('pr.listtowns')}}">
                            <i class="material-icons text-gray">flight</i>
                            <p>Towns</p>
                        </a></li>
                        <li><a href="{{route('pr.listlocations')}}">
                            <i class="material-icons text-gray">gps_not_fixed</i>
                            <p>Locations</p>
                        </a></li>
                        </ul>
                        </div>
	                 ...
	                 <li class="dropdown">
	                 <a href="#dropdownadverts" data-toggle="collapse" class="collapsed active"><i class="material-icons">album</i><p>Advert<b class="caret"></b></p></a>
	                 <div class="collapse" id="dropdownadverts">
                        <ul class="nav">
                            <li><a href="{{route('pr.newadvert')}}">
                            <i class="material-icons text-gray">album</i>
                            <p>Create Adverts</p>
                        </a></li>
                            <li><a href="{{route('pr.listadverts')}}">
                    ...
                    <li>
                        <a href="{{route('pr.listsubscribers')}}">
                    ...
                    <li>
                        <a href="{{route('pr.newemail')}}">
                            <i class="material-icons text-gray">mail</i>
                            <p>New Email</p>
                        </a>
                    </li><!-- 
                    <li>
             ...
             <nav class="navbar navbar-transparent" style="margin-bottom: 10px">
                ...
                <div class="ripple-container"></div>
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a style="margin-left: 15px; margin-top: 4px" class="btn btn-primary btn-default" data-toggle="modal" data-target="#noticeModal" id="loadsearch"><i class="material-icons">search</i> Search</a>
                                </div>
