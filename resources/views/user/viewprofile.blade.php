            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6" style="margin-bottom: 20px">
                        <p class="description">You can contact us with anything related to our listings. We'll get in touch with you as soon as possible.<br><br>
                        </p>
                        <form class="form" role="form" id="contact-form" method="POST" action="{{ route('em.sendmessage') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input type="email" value="{{$user->email}}" name="sendfrom" class="form-control" required/>
                            </div>
                            <div class="form-group label-floating">
