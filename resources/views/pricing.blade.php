				...
				<div class="col-md-4">
					<div class="card card-pricing card-raised">
						<div class="card-content content-primary">
							...
							<h1 class="card-title"><small>Ksh</small>0<small>/mo</small></h1>
							<ul>
								<li><b>Search for offices, businesses, companies, products and services at your own convenience</b></li>
			...
			<div class="tab-pane" id="yearly">
				...
				<div class="col-md-4">
					<div class="card card-pricing card-raised">
						<div class="card-content content-primary">
							<h6 class="category text-info">Free</h6>
							<h1 class="card-title"><small>Ksh</small>0<small>/yr</small></h1>
							<ul>
								<li><b>Search for offices, businesses, companies, products and services at your own convenience</b></li>
								<li><b>Single</b> User</li>
								<li><b>Mobile Money Integration</b></li>
