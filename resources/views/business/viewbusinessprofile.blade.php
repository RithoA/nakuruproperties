            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-1 follow">
	                   <button class="btn btn-fab btn-primary" rel="tooltip" title="follow business">
                            <i class="material-icons">add</i>
                        </button>
	                </div>
	                <div class="col-xs-1 follow">
	                   <button class="btn btn-fab btn-primary" rel="tooltip" title="star business">
                ...
                <div class="description text-center">
                    <p>An artist of considerable range, Chet Faker — the name taken by Melbourne-raised, Brooklyn-based Nick Murphy — writes, performs and records all of his own music. </p>
                </div>
						...
						<div class="profile-tabs">
		                    <div class="nav-align-center">
								...
								<li class="active">
			                        ...
			                        <li>
										<a href="#influencers" role="tab" data-toggle="tab">
                ...
                <div class="tab-content">
			        ...
			        <div class="tab-pane connections" id="influencers">
                        <div class="row">
