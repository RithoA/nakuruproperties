    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Towns Table</div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td class='text-center'>" +
                        data.id + "</td><td class='text-center'>" + data.name + "</td><td class='text-center'><button class='edit-modal btn btn-info' data-info='" + data.id+","+data.name+"'><span class='material-icons'>edit</span></button> <button class='delete-modal btn btn-danger' data-info='" + data.id+","+data.name+"'><span class='material-icons'>delete</span></button></td></tr>");
                 }}
        });
    });
