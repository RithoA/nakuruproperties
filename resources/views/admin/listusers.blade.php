...
<div class="content">
 ...
 <div class="main main-raisedlist">
    ...
    <td class="text-center"><div class="card-image">
                                            <a href="#pablo">
                                                <img class="img" src="{{ $item->avatar }}" style="height: 15vh; width: 10vw"/>
                                            </a>
                                        </div></td>
    ...
    <td class="text-center"><button class="edit-modal btn btn-info"
            data-info="{{$item->id}},{{$item->email}},{{$item->gender}},{{$item->type}}">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td class='text-center'>" +
                        data.id + "</td><td class='text-center'><div class='card-image'><a><img style='height: 15vh; width: 10vw' class='img'src='" + data.avatar + "'/></a></div></td><td class='text-center'>" + data.email + "</td><td class='text-center'>" +
